...
require File.expand_path(File.dirname(__FILE__) + '/../lib/2')

describe Options, 'when using no block with the constructor' do
  
  describe 'when using #set' do
    setup do
      @options = Options.new
...
describe Options, 'when using a block with the constructor and #set' do
...
describe Options, 'when using a block with the constructor and #on' do
